...
//     $shop_id = get_datan('shop_id'); 
    ...
    $retailer_id = get_data('retailer');
     ...
     $obj = new functions(); 
     if($row = $obj->save_retailer_and_shop($insert_retailer, $shop_name_shop, $shop_status, $governorate, $kazaa, $village, $location, $manager_name, $manager_contact, $email,
...
//    echo"this is the merchant code =$shop_status ";
    $obj = new functions(); 
if($obj->update_retailer_shops($village, $kazaa,$shop_status, $governorate, $location, $landline, $longitude, $latitude, $merchant_number, $merchant_code, $merchant_number_edited, $email, $manager_contact, $shop_name, $manager_name, $shop_id))
{
     echo "{";
        echo jsonn("result", 1);
