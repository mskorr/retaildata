...
//    echo"onload='showMessage()'";
    ...
    if($row['count1'] == 1)
    {
        echo "<BODY onLoad='showModal(\"$_REQUEST[b]\", 0)'>";
    } 
    
    $obj_decision = new functions();
    $obj_decision->barcode_detail($_REQUEST['b']);
    $row = $obj_decision->fetch(); 
    if($row['user_decision'] == 2)
    { 
        echo "<BODY onLoad='no(1,0,\"none\")'>";   
    }  
    else  if($row['user_decision'] == 1) 
    { 
        echo "<BODY onLoad='showModal(\"$_REQUEST[b]\", 0)'>";   
    } 
                            ...
                            <div class="panel-body">  
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        echo"<td style='display:none; color:green' onclick ='no(1,$row[a08retailer_shop], \"$row[ITEM_DESCRIPTION]\")' class='center edit'>Edit</td>"; 
                                       echo" </tr> "; 
                                          }
                                          else
                                          { 
                                        ...
                                        echo"<td style='display:none; color:red' onclick ='no(1,$row[a08retailer_shop], \"$row[ITEM_DESCRIPTION]\")' class='center edit'>Edit</td>"; 
                                       echo" </tr> "; 
                                          }
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalShop"></h4>
                                            </div>
