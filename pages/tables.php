...
//                                    echo "tables";
                                    ...
                                    { 
                                        ...
                                        <td class='center'>$row[BARCODE2]</td>
                                        <td class='center'>$row[ITEM_DESCRIPTION]</td>";
                                     
                                        echo"<td style='color:green'  class='center'><a href='barcode_check.php?b=$row[BARCODE2]'>Edit</a></td>"; 
                                       echo" </tr> "; 
                                          }
                                          else
                                          { 
                                        ...
                                        echo"<td class='center'><a href='barcode_check.php?b=$row[BARCODE2]'>Edit</a></td>"; 
                                       echo" </tr> "; 
                                          }
//                                     echo"<tr class='odd gradeX'>        
//                                        
